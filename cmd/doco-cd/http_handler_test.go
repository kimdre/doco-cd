...
func TestHandlerData_ProjectApiHandler(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Get Project", "/project/{projectName}", "/project/test", http.MethodGet, h.GetProjectApiHandler, http.StatusOK},
		{"Get Project - Non-existent Project", "/project/{projectName}", "/project/nonexistent", http.MethodGet, h.GetProjectApiHandler, http.StatusNotFound},
		{"Get Project - Missing Path Param", "/project/{projectName}", "/project/", http.MethodGet, h.GetProjectApiHandler, http.StatusNotFound},
		{"Restart Project", "/project/{projectName}/{action}", "/project/test/restart", http.MethodPost, h.ProjectApiHandler, http.StatusOK},
		{"Restart Project - Non-existent Project", "/project/{projectName}/{action}", "/project/nonexistent/restart", http.MethodPost, h.ProjectApiHandler, http.StatusNotFound},
		{"Restart Project - With Timeout", "/project/{projectName}/{action}", "/project/test/restart?timeout=60", http.MethodPost, h.ProjectApiHandler, http.StatusOK},
		{"Restart Project - Invalid Timeout", "/project/{projectName}/{action}", "/project/test/restart?timeout=x", http.MethodPost, h.ProjectApiHandler, http.StatusBadRequest},
		{"Restart Project - Invalid Method", "/project/{projectName}/{action}", "/project/test/restart", http.MethodGet, h.ProjectApiHandler, http.StatusMethodNotAllowed},
		{"Stop Project", "/project/{projectName}/{action}", "/project/test/stop", http.MethodPost, h.ProjectApiHandler, http.StatusOK},
		{"Stop Project - Non-existent Project", "/project/{projectName}/{action}", "/project/nonexistent/stop", http.MethodPost, h.ProjectApiHandler, http.StatusNotFound},
		{"Start Project", "/project/{projectName}/{action}", "/project/test/start", http.MethodPost, h.ProjectApiHandler, http.StatusOK},
		{"Remove Project - With all volumes", "/project/{projectName}/{action}", "/project/test/remove?volumes=true&images=false", http.MethodDelete, h.ProjectApiHandler, http.StatusOK},
		{"Remove Project - With all images", "/project/{projectName}/{action}", "/project/test/remove?volumes=false&images=true", http.MethodDelete, h.ProjectApiHandler, http.StatusOK},
		{"Remove Project - Invalid images Param", "/project/{projectName}/{action}", "/project/test/remove?&images=x", http.MethodDelete, h.ProjectApiHandler, http.StatusBadRequest},
		{"Remove Project - Invalid volumes Param", "/project/{projectName}/{action}", "/project/test/remove?volumes=x", http.MethodDelete, h.ProjectApiHandler, http.StatusBadRequest},
		{"Invalid Action", "/project/{projectName}/{action}", "/project/test/invalid", http.MethodPost, h.ProjectApiHandler, http.StatusBadRequest},
	}
