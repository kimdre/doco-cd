...
|-----------------------------------|---------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|
| `API_SECRET`                      | string  | Secret that is used to authenticate requests to the REST API (see [REST API](Endpoints.md#rest-api))                                                                                                                                                     | ` ` (Rest API is disabled when not specified)          |
...
| `METRICS_PORT`                    | number  | Port on which the application will expose [Prometheus metrics](Endpoints.md#prometheus-metrics)                                                                                                                                                          | `9120`                                                 |
