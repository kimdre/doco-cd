...
| `SSH_PRIVATE_KEY`                 | string  | The private key used for cloning repositories via SSH, see [SSH Key Setup](Setup-SSH-Key.md). For domain-scoped authentication, see [Domain-scoped Git auth](#domain-scoped-git-authentication).                                                                                                                                                       | ` `                                                    |
