...
| `OPENAPI_ENABLED`            | boolean        | Exposes public REST and webhook OpenAPI specifications and Swagger UIs under `/openapi/` and `/docs/`.                                                                                                                                                                                                                                                                                                  | `false`                                                       |
...
| `PPROF_ENABLED`              | boolean        | Enables the loopback-only [Go runtime profiling server](Endpoints/Profiling.md).                                                                                                                                                                                                                                                                                                                        | `false`                                                       |
| `PPROF_PORT`                 | number         | Loopback port used by the Go runtime profiling server when enabled.                                                                                                                                                                                                                                                                                                                                     | `6060`                                                        |
