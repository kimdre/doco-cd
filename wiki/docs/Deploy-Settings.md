...
| `reconciliation`   | object           | Enables periodic reconciliation feature. default is `{enable: true, interval: 60}`. see [reconciliation settings](#reconciliation-settings) for more details.                                                                                                                                                                                                                                                                                                                        | `{enable: true, interval: 60}`                                                                                         |
...
The following settings can be used to configure periodic reconciliation feature.

!!! warning
    Currently implemented state will lost on restart of doco-cd.
