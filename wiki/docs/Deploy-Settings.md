...
| `context`           | string            | Docker context to use for this deployment. This lets you deploy a specific stack/project to a non-default Docker context.                                                                                                                                                                                                                                                                                                                                                            | ` ` (Default Docker context)                                                                                            |
