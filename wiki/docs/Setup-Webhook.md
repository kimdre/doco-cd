...
See the [Custom webhook using Github actions](#custom-webhook-using-github-actions) section for an example of how to build and send the webhook payload with HMAC SHA256 signature.

Azure Devops users need to adjust this so that it works with their CI pipelines.
