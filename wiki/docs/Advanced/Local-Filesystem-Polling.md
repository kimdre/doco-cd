...
- If the watcher fails to start, is disabled (`watch: false`), or closes unexpectedly while `interval: 0`, doco-cd falls back to a 24h safety-net poll interval instead of never polling again.
