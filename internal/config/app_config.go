...
type AppConfig struct {
	...
	DeployConfigBaseDir   string                 `env:"DEPLOY_CONFIG_BASE_DIR"`                                             // DeployConfigBaseDir is the base directory (relative to the repository root) where deployment configuration files will be searched for.
