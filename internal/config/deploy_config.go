...
type DeployConfig struct {
	...
	Reconciliation struct {
		...
		RestartSignal  string   `yaml:"restart_signal" json:"restart_signal" default:"SIGTERM"`  // RestartSignal is the signal sent to stop containers during a restart. Empty uses Docker's default signal.
