...
func TestRecreateVolumesWithChangedConfig_RecreatesTmpfsVolumes(t *testing.T) {
	t.Parallel()
...
func TestRecreateVolumesWithChangedConfig_StopsRunningContainersBeforeRemove(t *testing.T) {
	t.Parallel()
