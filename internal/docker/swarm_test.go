...
func TestDeploySwarmStack(t *testing.T) {
	...
	repo, err := git.CloneRepository(tmpDir, p.CloneURL, git.SwarmModeBranch, c.SkipTLSVerification, c.HttpProxy, c.SSHPrivateKey, c.SSHPrivateKeyPassphrase, c.GitCloneSubmodules)
	if err != nil {
