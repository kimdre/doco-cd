...
func newStackActionRESTSuccessTestHandler(t *testing.T, services []dockerswarmtypes.Service) *Handler {
	t.Helper()
...
func callStackActionREST(t *testing.T, h *Handler, requestPath string) *httptest.ResponseRecorder {
	t.Helper()
...
func newStackActionRESTTestHandler(t *testing.T, services []dockerswarmtypes.Service, actionRequests *int) *Handler {
	t.Helper()
