...
type (
	...
	deploymentRunTrigger = RunTrigger
)
...
const (
	deploymentRunStatusAccepted  = RunStatusAccepted
	deploymentRunStatusRunning   = RunStatusRunning
	deploymentRunStatusSucceeded = RunStatusSucceeded
	deploymentRunStatusFailed    = RunStatusFailed
	deploymentRunStatusSkipped   = RunStatusSkipped
)
...
const (
	deploymentRunTriggerWebhook      = RunTriggerWebhook
	deploymentRunTriggerPoll         = RunTriggerPoll
	deploymentRunTriggerScheduledJob = RunTriggerScheduledJob
)
