...
| [self-updating](self-updating/) | doco-cd deploys the stack that contains itself. One instance, bootstrapped once, updated by a push. | You want the controller under GitOps too, like the stacks it deploys. |
